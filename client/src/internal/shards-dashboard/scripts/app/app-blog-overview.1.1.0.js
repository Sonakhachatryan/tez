...
(function ($) {
  $(document).ready(function () {
    ...
    var bouCtx = document.getElementsByClassName('blog-overview-allUsers')[0];
    ...
    var ubdCtx = document.getElementsByClassName('blog-allUsers-by-device')[0];

    // Generate the allUsers by device chart.
